...
import rebusBackground from "/src/assets/rebus_04/rebus_04.png";
import finalScreen from "/src/assets/final_rebus_screen.png";

// Варианты ответов
import word_1 from "/src/assets/rebus_04/word_1.png";
import word_2 from "/src/assets/rebus_04/word_2.png";
import word_3 from "/src/assets/rebus_04/word_3.png";
import word_4 from "/src/assets/rebus_04/word_4.png";

import word_1_F from "/src/assets/rebus_04/word_1_F.png";
import word_2_F from "/src/assets/rebus_04/word_2_F.png";
import word_3_F from "/src/assets/rebus_04/word_3_F.png";
import word_4_F from "/src/assets/rebus_04/word_4_F.png";

export class RebusScene04 extends Phaser.Scene {
    constructor() {
        super("RebusScene4");
    }
    ...
    create() {
        ...
        // Варианты ответов (правильный → word_1)
        this.answers = [
            { key: "word_1", final: "word_1_F", x: 1620, y: 250, isTrue: true  }, // ← правильный
            { key: "word_2", final: "word_2_F", x: 1590, y: 450, isTrue: false },
            { key: "word_3", final: "word_3_F", x: 1650, y: 650, isTrue: false },
            { key: "word_4", final: "word_4_F", x: 1550, y: 850, isTrue: false },
        ];
