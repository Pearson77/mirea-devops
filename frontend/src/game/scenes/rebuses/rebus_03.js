...
import rebusBackground from "/src/assets/rebus_03/rebus_03.png";
...
export class RebusScene03 extends Phaser.Scene {
    constructor() {
        super("RebusScene3");
    }
    ...
    create() {
        ...
        this.answers = [
            { key: "word_1", final: "word_1_F", x: 400,  y: 900, isTrue: false },
            { key: "word_2", final: "word_2_F", x: 770,  y: 900, isTrue: false },
            { key: "word_3", final: "word_3_F", x: 1150, y: 900, isTrue: true  }, // ← правильный
            { key: "word_4", final: "word_4_F", x: 1550, y: 900, isTrue: false },
        ];
