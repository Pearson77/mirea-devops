...
import rebusBackground from "/src/assets/rebus_01/rebus_01.png";
import finalScreen from "/src/assets/final_rebus_screen.png";

// Варианты ответов
import word_1 from "/src/assets/rebus_01/word_1.png";
import word_2 from "/src/assets/rebus_01/word_2.png";
import word_3 from "/src/assets/rebus_01/word_3.png";
import word_4 from "/src/assets/rebus_01/word_4.png";

import word_1_F from "/src/assets/rebus_01/word_1_F.png";
import word_2_F from "/src/assets/rebus_01/word_2_F.png";
import word_3_F from "/src/assets/rebus_01/word_3_F.png";
import word_4_F from "/src/assets/rebus_01/word_4_F.png";

export class RebusScene01 extends Phaser.Scene {
    constructor() {
        super("RebusScene1");
    }
    ...
    create() {
        ...
        // Варианты ответов
        this.answers = [
            { key: "word_1", final: "word_1_F", x: 350,  y: 870, isTrue: false },
            { key: "word_2", final: "word_2_F", x: 720,  y: 870, isTrue: true  }, // ← правильный
            { key: "word_3", final: "word_3_F", x: 1100, y: 870, isTrue: false },
            { key: "word_4", final: "word_4_F", x: 1550, y: 870, isTrue: false },
        ];
