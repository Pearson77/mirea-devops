...
import rebusBackground from "/src/assets/rebus_05/rebus_05.png";
...
export class RebusScene05 extends Phaser.Scene {
    constructor() {
        super("RebusScene5");
    }
    ...
    create() {
        ...
        // Варианты ответов (правильный → word_3)
        this.answers = [
            { key: "word_1", final: "word_1_F", x: 1550, y: 250, isTrue: false },
            { key: "word_2", final: "word_2_F", x: 1535, y: 450, isTrue: false },
            { key: "word_3", final: "word_3_F", x: 1570, y: 650, isTrue: true  }, // ← правильный
            { key: "word_4", final: "word_4_F", x: 1590, y: 850, isTrue: false },
        ];
